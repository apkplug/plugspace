...
//                            }
//                        });
                        PlugManager.getInstance().installAssets("easeplug-debug.apk", "1.0.0", new OnInstallListener() {
                            @Override
...
//    private void chatInitandLogin(final IEaseInstance easeInstance) {
//        textView.setText(textView.getText()+"\n获取好友列表");
